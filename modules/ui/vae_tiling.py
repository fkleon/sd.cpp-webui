...
def create_vae_tiling_ui():
    ...
    with gr.Accordion(label="VAE Tiling", open=False):
        vae_tiling = gr.Checkbox(label="VAE Tiling", value=config.get("def_vae_tiling"))
        ...
        vae_tile_comp = [vae_tile_overlap, vae_tile_size, vae_relative_bool]
